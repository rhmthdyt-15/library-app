// src/components/dashboard/RecentBooks.tsx
...
export const RecentBooks: React.FC<RecentBooksProps> = ({ books }) => {
  if (books.length === 0) {
    return (
      <div className="bg-gray-50 p-6 rounded-lg shadow">
        <h3 className="text-xl font-semibold mb-4">Buku Terbaru</h3>
        <p className="text-gray-500">Belum ada data buku terbaru.</p>
      </div>
    );
  }
